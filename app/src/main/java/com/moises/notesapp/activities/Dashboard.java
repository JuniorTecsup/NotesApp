package com.moises.notesapp.activities;
...
import com.moises.notesapp.fragments.FavoriteFragment;
import com.moises.notesapp.fragments.HomeFragment;
import com.moises.notesapp.fragments.SaveFragment;
...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bienvenida.setText("Bienvenido " + getIntent().getExtras().getString("user"));
